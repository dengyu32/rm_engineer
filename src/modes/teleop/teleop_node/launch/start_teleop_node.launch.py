...
def generate_launch_description():
    ...
    urdf_path = os.path.join(moveit_config_pkg, 'config', 'engineer_v5.urdf.xacro')
    srdf_path = os.path.join(moveit_config_pkg, 'config', 'engineer_v5.srdf')
    ...
    moveit_reset = os.path.join(robot_config_share, 'config', 'moveit_reset.yaml')
